...
Read this first. Every wiki page, one line each.

## Core
| Page | What it's for |
|---|---|
| [training-model.md](training-model.md) | The decisions: principles, base week, gym structure, phases, race modes, testing |
